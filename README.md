...
condition as a clone — the suite is **733 tests: 591 passed, 142 skipped, 0
failed, 0 xfailed**, read off pytest's own summary line rather than
remembered: 159 tests added since `4c852a7` (137 of them on 25 Sep: 45 for
the reply drafts' wording pass, 6 for in-place review, value corrections,
review counts and scan state, 86 from testing on real external documents), and the former
...
`4c852a7`, and **733 passed, 0 skipped, 0 xfailed** on 25 Sep.
...
backend/tests/         733 tests over the traps in docs/DATA_NOTES.md
