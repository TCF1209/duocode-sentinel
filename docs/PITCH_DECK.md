...
CGM's SI template — one bug found and fixed. *Engineering:* 757 tests, 0
...
| 757 tests, 0 failing (615 passed, 142 skipped without the dataset) | `pytest --junitxml`, 25 Sep, on the final-round working tree (no `data/bundle`) |
