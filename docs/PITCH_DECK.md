...
CGM's SI template — one bug found and fixed. *Engineering:* 732 tests, 0
...
| 732 tests, 0 failing (590 passed, 142 skipped without the dataset) | `pytest --junitxml`, 25 Sep, on the final-round working tree (no `data/bundle`) |
