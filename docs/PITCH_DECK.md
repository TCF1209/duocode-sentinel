...
CGM's SI template — one bug found and fixed. *Engineering:* 756 tests, 0
...
| 756 tests, 0 failing (614 passed, 142 skipped without the dataset) | `pytest --junitxml`, 25 Sep, on the final-round working tree (no `data/bundle`) |
